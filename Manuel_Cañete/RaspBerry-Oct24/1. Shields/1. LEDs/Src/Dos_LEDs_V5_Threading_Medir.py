...
pinled1 = 4
pinled2 = 17
interval_led1 = 5  # Interval per al LED 1	(tiempo ampliado para medir con multimetro)
interval_led2 = 3  # Interval per al LED 2	(tiempo ampliado para medir con multimetro)
